      ...
      <div class="max-w-4xl">
        ...
        <div class="prose prose-lg mx-auto text-center leading-relaxed space-y-6">
          ...
          <div class="text-center mt-8">
            <p class="text-lg font-semibold italic text-rayan-light">
              {{ $t('contact.presidentClosing') }}
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-base-300 flex flex-col justify-center items-center">
          <div class="card-body flex flex-col justify-center items-center">
            <div class="flex justify-center items-center gap-6 mb-6">
              ...
              >
                <svg
                  class="w-16 h-16 text-primary hover:text-primary-focus"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              >
                <svg
                  class="w-16 h-16 text-green-600 hover:text-green-700"
                  fill="currentColor"
                  viewBox="0 0 24 24"
                >
