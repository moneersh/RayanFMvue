          ...
          <div class="card bg-base-100 shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-base-300">
            <div class="card-body text-center p-8">
              <a 
                ...
                class="flex justify-center mb-6 hover:scale-110 transition-transform duration-300"
              >
                <svg class="w-16 h-16 text-primary hover:text-primary-focus" fill="currentColor" viewBox="0 0 24 24">
              ...
              <div class="space-y-4">
                <a 
                  ...
                  class="flex items-center justify-center text-lg font-semibold text-green-600 hover:text-green-700 transition-colors duration-300 hover:underline"
                >
