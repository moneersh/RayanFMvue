<template>
            ...
            <div class="relative flex items-center justify-center">
              ...
              <div>
                ...
                <div class="text-sm opacity-90">
                  {{ $t('hero.title') === 'إذاعة الريان' ? 'اضغط للاستماع' : 'Click to Listen' }}
                </div>
              </div>
            </div>
          ...
          >
            <div class="flex items-center justify-center">
              ...
              <div>
                ...
                <div class="text-sm opacity-90">
                  {{ $t('hero.title') === 'إذاعة الريان' ? 'استكشف المزيد' : 'Discover More' }}
                </div>
              </div>
            </div>
          </router-link>
  ...
  <section class="py-20 bg-gradient-to-br from-gray-50 via-base-200 to-primary/5 relative overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-5">
      <div class="absolute top-20 left-20 w-32 h-32 bg-secondary rounded-full blur-xl" />
      <div class="absolute bottom-20 right-20 w-24 h-24 bg-accent rounded-full blur-xl" />
    </div>
    ...
    <div class="container mx-auto px-4 relative z-10">
      ...
      <div class="max-w-5xl mx-auto">
        ...
        <div class="text-center mt-16">
          ...
          >
            <div class="text-2xl mr-4 group-hover:animate-bounce">
              📻
            </div>
            <div>
              <div>{{ $t('hero.title') === 'إذاعة الريان' ? 'عرض جميع البرامج' : 'Display All Programs' }}</div>
              <div class="text-sm opacity-90">
                {{ $t('hero.title') === 'إذاعة الريان' ? 'مع الصور والتفاصيل' : 'With Images & Details' }}
              </div>
            </div>
            <svg
              class="w-6 h-6 ml-4 group-hover:translate-x-2 transition-transform duration-300"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
