<template>
  <div class="min-h-screen bg-rayan-light">
      ...
      <div class="hero-content text-center text-white relative z-10">
        <div class="max-w-4xl">
          ...
          <p class="mb-5 text-2xl font-semibold text-rayan-light">
            {{
              locale === "ar"
                ? "مجموعة متنوعة من البرامج الثقافية والاجتماعية وتعرف على فريق العمل المميز"
                : "A diverse collection of cultural and social programs and meet our amazing crew"
            }}
          </p>
          <p class="mb-8 text-lg text-rayan-gray">
            {{
              locale === "ar"
                ? "استكشف عالم الإذاعة معنا واستمتع بأفضل المحتوى"
                : "Explore the world of radio with us and enjoy the best content"
            }}
          </p>
          <div
          ...
          >
            ...
            >
              <!-- Animated background -->
              <div
                class="absolute inset-0 bg-gradient-to-r from-rayan-purple via-rayan-orange to-rayan-purple opacity-0 group-hover:opacity-100 transition-opacity duration-500"
              />

              <!-- Live indicator -->
              <div class="absolute top-2 right-2 flex items-center">
                <div
                  class="w-3 h-3 bg-rayan-orange rounded-full animate-pulse mr-2"
                />
              ...
              <!-- Ripple effect -->
              <div
                class="absolute inset-0 rounded-2xl opacity-30 group-hover:animate-ping bg-white"
              />
            </button>
    ...
    <section
      class="py-20 bg-gradient-to-br from-rayan-light via-white to-rayan-orange/10 relative overflow-hidden"
    >
      <!-- Background decorative elements -->
      <div class="absolute inset-0 opacity-10">
        <div
          class="absolute top-10 left-10 w-32 h-32 bg-rayan-orange rounded-full blur-xl"
        />
        <div
          class="absolute bottom-10 right-10 w-24 h-24 bg-rayan-purple rounded-full blur-xl"
        />
        <div
          class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-40 h-40 bg-rayan-orange rounded-full blur-2xl"
        />
      </div>
      ...
      <div class="container mx-auto px-4 text-center relative z-10">
        <div class="mb-12">
          <h2
            class="text-4xl md:text-5xl font-black text-rayan-purple mb-6 bg-gradient-to-r from-rayan-purple to-rayan-orange bg-clip-text text-transparent"
          >
          ...
          <p class="text-xl text-rayan-dark/80 max-w-2xl mx-auto">
            {{
              locale === "ar"
                ? "انضم إلينا واستمع إلى أفضل البرامج مباشرة من إذاعة الريان"
                : "Join us and listen to the best programs live from Rayan Radio"
            }}
          </p>
        </div>
        ...
        >
          ...
          >
            <!-- Animated background -->
            <div
              class="absolute inset-0 bg-gradient-to-r from-red-500 via-pink-500 to-purple-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500"
            />
          ...
          <!-- Download App Button -->
          <button
            class="group bg-white hover:bg-gray-50 text-gray-800 px-10 py-6 rounded-2xl font-semibold text-lg transition-all duration-300 hover:scale-105 hover:shadow-xl border-2 border-gray-200 hover:border-primary/30"
          >
            <div class="flex items-center justify-center">
              <div class="text-2xl mr-3 group-hover:animate-bounce">📱</div>
              <div>
        ...
        >
          <div
            class="flex items-center bg-green-100 text-green-800 px-6 py-3 rounded-full"
          >
            <div
            ...
            <span class="font-semibold">{{
              locale === "ar" ? "الإذاعة متصلة" : "Radio Online"
            }}</span>
          </div>
          <div class="text-gray-600">
            <span class="font-medium">{{
              locale === "ar" ? "المستمعون الآن:" : "Listeners Now:"
            }}</span>
