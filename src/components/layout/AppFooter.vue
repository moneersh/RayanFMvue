<template>
  ...
  <footer class="relative bg-gradient-to-br from-rayan-dark via-rayan-purple to-rayan-dark text-white overflow-hidden">
    ...
    <div class="absolute inset-0 opacity-10">
      <div class="absolute top-0 left-0 w-72 h-72 bg-rayan-orange rounded-full mix-blend-multiply filter blur-xl animate-pulse"></div>
      <div class="absolute top-0 right-0 w-72 h-72 bg-rayan-purple rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000"></div>
