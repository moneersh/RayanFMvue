<template>
  <!-- Footer -->
  <footer class="relative bg-gradient-to-br from-rayan-dark via-rayan-purple to-rayan-dark text-white overflow-hidden">
    <!-- Decorative Background Elements -->
    <div class="absolute inset-0 opacity-10">
      <div class="absolute top-0 left-0 w-72 h-72 bg-rayan-orange rounded-full mix-blend-multiply filter blur-xl animate-pulse" />
      <div class="absolute top-0 right-0 w-72 h-72 bg-rayan-purple rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-2000" />
      <div class="absolute bottom-0 left-1/3 w-72 h-72 bg-rayan-orange rounded-full mix-blend-multiply filter blur-xl animate-pulse animation-delay-4000" />
    </div>
      ...
      >
        ...
        <div class="space-y-8">
          <div class="flex items-center mb-10">
            <div class="w-3 h-16 bg-gradient-to-b from-rayan-orange to-rayan-purple rounded-full mr-5 shadow-lg" />
            <h3 class="font-bold text-4xl bg-gradient-to-r from-white via-rayan-orange to-rayan-purple bg-clip-text text-transparent">
              {{ $t('footer.about') }}
            </h3>
          </div>
          <p class="text-lg leading-relaxed text-white/90 mb-10 max-w-2xl font-medium">
          ...
          <div class="space-y-6">
            ...
            <div class="flex gap-4 flex-wrap">
              ...
              >
                ...
                <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400/30 to-blue-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </a>
              ...
              >
                ...
                <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-pink-400/30 to-purple-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </a>
              ...
              >
                ...
                <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-red-400/30 to-red-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </a>
              ...
              >
                ...
                <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-blue-400/30 to-cyan-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </a>
              ...
              >
                ...
                <div class="absolute inset-0 rounded-2xl bg-gradient-to-r from-green-400/30 to-green-600/30 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-8">
          <div class="flex items-center mb-10">
            <div class="w-3 h-16 bg-gradient-to-b from-rayan-purple to-rayan-orange rounded-full mr-5 shadow-lg" />
