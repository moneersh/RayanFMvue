<template>
  ...
  >
    ...
    <div class="absolute inset-0 bg-rayan-light/95 backdrop-blur-lg border-t border-rayan-gray/50 shadow-lg"></div>
    
    <!-- Animated Background Elements -->
    <div class="absolute inset-0 overflow-hidden">
      <div class="absolute -top-20 -left-20 w-40 h-40 bg-gradient-to-r from-rayan-orange/20 to-rayan-purple/20 rounded-full blur-3xl animate-pulse"></div>
      <div class="absolute -top-20 -right-20 w-40 h-40 bg-gradient-to-r from-rayan-purple/20 to-rayan-orange/20 rounded-full blur-3xl animate-pulse" style="animation-delay: 1s;"></div>
    </div>
      ...
      <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4 flex-1 min-w-0">
          ...
          <div class="relative group">
            ...
            <div v-if="playerStore.isLive" class="absolute -top-1 -right-1 bg-rayan-orange text-white text-xs px-2 py-1 rounded-full font-bold animate-pulse shadow-lg">
              LIVE
            </div>
            <!-- Sound waves animation -->
            <div class="absolute inset-0 rounded-2xl border-2 border-rayan-orange/30 animate-ping"></div>
          </div>
          ...
          <div class="flex-1 min-w-0">
            ...
            <p v-if="playerStore.currentTrack.artist" class="text-rayan-purple/70 text-sm truncate mb-1">
              {{ playerStore.currentTrack.artist }}
            </p>
            <div v-if="playerStore.isLive" class="flex items-center text-rayan-orange text-sm font-medium">
              <div class="w-2 h-2 bg-rayan-orange rounded-full mr-2 animate-pulse"></div>
        ...
        <div class="flex items-center space-x-6 mx-8">
          ...
          <button class="group p-3 rounded-full bg-rayan-gray hover:bg-rayan-orange/10 transition-all duration-300 hover:scale-110 disabled:opacity-50" disabled>
            <svg class="w-5 h-5 text-rayan-purple group-hover:text-rayan-orange transition-colors duration-300" fill="currentColor" viewBox="0 0 24 24">
          ...
          >
            <!-- Button Glow Effect -->
            <div class="absolute inset-0 rounded-full bg-gradient-to-r from-rayan-orange to-rayan-purple opacity-0 group-hover:opacity-30 blur transition-opacity duration-300"></div>
          ...
          >
            <svg class="w-5 h-5 text-rayan-purple group-hover:text-rayan-orange" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="flex items-center space-x-4 flex-1 justify-end">
          ...
          <div v-if="!playerStore.isLive && playerStore.currentTrack.duration" 
            ...
            <div class="flex-1 h-2 bg-rayan-gray rounded-full overflow-hidden cursor-pointer group">
              <div class="h-full bg-gradient-to-r from-rayan-orange to-rayan-purple rounded-full transition-all duration-300 group-hover:shadow-lg" 
          ...
          <div class="hidden sm:flex items-center space-x-3 bg-rayan-gray rounded-full px-4 py-2 backdrop-blur-sm">
            <svg class="w-5 h-5 text-rayan-purple" fill="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            class="group p-3 rounded-full bg-rayan-gray hover:bg-rayan-orange/10 transition-all duration-300 hover:scale-110"
          >
            <svg class="w-5 h-5 text-rayan-purple group-hover:text-rayan-orange transition-all duration-300" :class="{ 'rotate-180': !isVisible }" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button 
            ...
            class="group p-3 rounded-full bg-rayan-gray hover:bg-rayan-orange/10 transition-all duration-300 hover:scale-110"
          >
            <svg class="w-5 h-5 text-rayan-purple group-hover:text-rayan-orange" fill="none" stroke="currentColor" viewBox="0 0 24 24">
